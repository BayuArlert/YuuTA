...
export async function GET(_req: NextRequest, { params }: Params) {
  ...
  const exportData: ExportDocumentData = {
    ...
    templateKey: document.templateKey || "STEKOM",
    citationStyle: document.citationStyle as CitationStyleValue,
    authorName: document.authorName || document.user.name || "Mahasiswa / Peneliti",
    studentNim: document.studentNim || undefined,
    studyProgram: document.studyProgram || "Teknik Informatika",
    institution: document.institution || "Universitas STEKOM",
    academicYear: document.academicYear || new Date().getFullYear().toString(),
